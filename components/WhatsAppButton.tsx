...
const WHATSAPP_NUMBER = '5511963897940'
  ...
  return (
    <div className={`relative z-40 flex justify-center pt-0 ${spacing}`}>
      <Link
        ...
        className="inline-flex items-center gap-3 px-12 py-4 border border-refined-gold bg-refined-gold text-refined-ivory shadow-[0_0_10px_rgba(212,175,55,0.6),0_0_20px_rgba(212,175,55,0.4)] hover:scale-105 hover:shadow-[0_0_15px_rgba(212,175,55,0.8),0_0_30px_rgba(212,175,55,0.6),0_0_40px_rgba(212,175,55,0.4)] transition-all duration-500 ease-in-out font-body text-base md:text-lg"
      >
